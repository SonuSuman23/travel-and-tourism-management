...
public class CheckHotel extends JFrame implements Runnable{
    ...
    JLabel caption;
    public void run(){
        String[] text = new String[]{"JW Marriott Hotel", "Madarin oriental Hotel", "Four season hotel", "Raddisson Blue Hotel", "classio Hoel", "The Bay club Hotel", "breeze Blow Hotel", "The Taj Hotel", "Happy Morning Motel", "River View Hotel"};
        try{
            for(int i=0; i<=9; i++){
