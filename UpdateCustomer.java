...
public class UpdateCustomer extends JFrame implements ActionListener{
    ...
    UpdateCustomer(String username){
        ...
        lbelusername = new JLabel();
        lbelusername.setBounds(220,50,150,25);
        add(lbelusername);
        ...
        try{
            ...
            lbelusername.setText(rs.getString("name"));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==add){
            String username = lbelusername.getText();
