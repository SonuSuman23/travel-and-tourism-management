...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        security = new Choice();
        security.add("Fav Char from the boys");
        security.add("Fav car");
        security.add("First pet");
        security.add("First school name");
        security.setBounds(190, 140,80,25);
        p1.add(security);
        ...
        create.setFont(new Font("Thoma", Font.BOLD,14));
        ...
        back.setFont(new Font("Thoma", Font.BOLD,14));
